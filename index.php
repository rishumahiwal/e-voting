    ...
    <body class="bg-primary">
        ...
        <div class="container" style="margin-top:50px;padding:30px;">
            ...
            <div class="row">
                ...
                <div class="col-sm-5" style="background-color:white;color:black;border-radius:10px;padding:36px;margin:40px;" >
                ...
                <div class="col-sm-5" style="background-color:white;color:black;border-radius:10px;margin:40px;padding-bottom:40px;padding-top:20px;padding-left:20px;padding-right:20px;">
                    <form method="post">
                        <div class="form-group">
                            <label for="voterid">Voter ID</label>
                            <input type="number" required name="txtvoterid" class="form-control" id="vid">
                        </div>
                        <div class="form-group">
                            <label for="pwd">Password</label>
                            <input type="password" required name="txtvoterpwd" class="form-control"  id="pwd">
                        </div>
